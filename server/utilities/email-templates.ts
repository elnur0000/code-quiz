...
<![endif]-->
 <center style="width:100%;table-layout:fixed;-webkit-text-size-adjust:100%;-ms-text-size-adjust:100%;background-color:#e1e5e8;">
   <div style="max-width:600px;margin-top:20px;margin-bottom:0;margin-right:auto;margin-left:auto;">
...
export const testInvitationTemplate = (url: string): string => {
  return `<head>
  <meta http-equiv="Content-Type" content="text/html; charset=utf-8">
  <!--[if !mso]><!-->
  <meta http-equiv="X-UA-Compatible" content="IE=edge">
              ...
              <table style="border-spacing:0;" width="100%">
                <tbody>
                  ...
                  <tr>
                    <td class="inner contents center" style="padding-top:15px;padding-bottom:15px;padding-right:30px;padding-left:30px;text-align:left;">
                      <center>
                        <p class="h1 center" style="Margin:0;text-align:center;font-family:'flama-condensed','Arial Narrow',Arial;font-weight:100;font-size:30px;Margin-bottom:26px;">You have been invited to a programming test</p>
                        <!--[if (gte mso 9)|(IE)]><![endif]-->


                        <!--[if (gte mso 9)|(IE)]><br>&nbsp;<![endif]-->
                       <a href=${url}> <button style="border-width: 0px; margin-top: 30px; margin-bottom: 50px; width: 260px; height: 54px;color:white;background-color:black" width="260">CLICK TO ACCEPT</button>  </a>
